...
class HRCriteriaSeeder extends Seeder
{
    ...
    {
        $this->command->info('🚀 Starting HR criteria seeding...');
    ...
    {
        // Template للأسئلة لتجنب التكرار
        $standardOptions = ['غير موجود', 'قيد الإعداد', 'مطبق جزئياً', 'مطبق', 'مطبق بالكامل وموثق'];
        $standardPointsMapping = [
            'غير موجود' => 0,
            'قيد الإعداد' => 40,
            'مطبق جزئياً' => 60,
            'مطبق' => 80,
        ...
        return [
            ...
            // ==========================================================
            // المحور 6: الثقافة والرضا الوظيفي (15%)
            // ==========================================================
            [
            ...
            // ==========================================================
            // المحور 7: الالتزام والتشريعات (10%)
            // ==========================================================
            [
                ...
                'questions' => [
                    ...
                    [
                        'question_text' => 'هل توجد سياسات وموارد بشرية مكتوبة ومعتمدة؟',
                        'options' => $standardOptions,
                        'points_mapping' => $standardPointsMapping,
                        'attachment_required' => true,
                        'weight' => 0.20,
                    ...
                    [
                        'question_text' => 'هل يتم تحديث اللوائح مع صدور أنظمة جديدة؟',
                        'options' => $standardOptions,
                        'points_mapping' => $standardPointsMapping,
                        'attachment_required' => true,
                        'weight' => 0.15,
                    ...
                    [
                        'question_text' => 'هل هناك التزام باللوائح الحكومية للقطاع غير الربحي؟',
                        'options' => $standardOptions,
                        'points_mapping' => $standardPointsMapping,
                        'attachment_required' => true,
                        'weight' => 0.15,
